def radial_data(data,annulus_width=1,working_mask=None,x=None,y=None,z=None,rmax=None):
    """
...
#        x,y = ny.meshgrid(y1,x1)
    ...
    #---------------------
    dr = 1.0 #ny.abs([x[0,0,0] - x[0,0,1]]) * annulus_width
